    ...
    public partial class FrmRayonmt : Form
    {
        ...
        private void btn_ajouter_Click(object sender, EventArgs e)
        {
            ...
            while (dr.Read())
            {
                ...
                rayonnements.Point = dr[3].ToString();
                rayonnements.Gisement = 0;
                if (dr[5].ToString() != string.Empty)
                    rayonnements.Ah2 = double.Parse(dr[5].ToString());
                if (dr[6].ToString() != string.Empty)
                    rayonnements.Distance = double.Parse(dr[6].ToString());
                if (dr[10].ToString() != string.Empty)
                    rayonnements.X = double.Parse(dr[10].ToString());
                if (dr[11].ToString() != string.Empty)
                    rayonnements.Y = double.Parse(dr[11].ToString());
                rayonnements.Ref = dr[13].ToString();
        ...
        private void dgRayonmt_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
